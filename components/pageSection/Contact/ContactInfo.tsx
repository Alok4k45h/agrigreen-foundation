    ...
    >
      ...
      <div className="bg-card border border-border p-8 rounded-3xl relative overflow-hidden group shadow-lg">
        ...
        <p className="text-muted-foreground mb-6 leading-relaxed">
          Enjoy a 15-minute no-obligation chat to discuss your sustainable
          farming goals. Send us a message and we&apos;ll take care of the rest.
        </p>
        ...
        {[
          {
            ...
            color:
              "hover:text-[#1877f2] hover:bg-[#1877f2]/10 hover:border-[#1877f2]/20",
          },
          {
            icon: Instagram,
            href: "https://www.instagram.com/agrigreenfoundation",
            color:
              "hover:text-[#e1306c] hover:bg-[#e1306c]/10 hover:border-[#e1306c]/20",
          },
          {
            icon: Youtube,
          ...
          },
          {
            ...
            color:
              "hover:text-[#0077b5] hover:bg-[#0077b5]/10 hover:border-[#0077b5]/20",
          },
        ].map((social, idx) => (
          <a
            key={idx}
