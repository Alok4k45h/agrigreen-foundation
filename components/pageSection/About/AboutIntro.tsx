    ...
    <section className="relative overflow-hidden bg-background py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-20">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          >
            <div className="relative overflow-hidden rounded-3xl border border-nature/20 bg-secondary/30 p-8 shadow-lg backdrop-blur-xl md:p-12">
              {/* Soft inner glow */}
              ...
              <div className="relative space-y-6">
                ...
                >
                  ...
                  Our mission is to combat climate change and restore ecosystems
                  by integrating innovative agricultural practices with
                  cutting-edge technology.
                  <br />
                  <br />
                  Our team consists of experts from a wide range of fields,
                  including agriculture, environment, forestry, and technology,
                  all working collaboratively to implement best practices in
                  crop production and land management. By combining traditional
                  knowledge with modern advancements, we empower communities to
                  adopt sustainable solutions that nurture both the land and its
                  people.
                  <br />
                  <br />
                  We are committed to driving positive change, ensuring
                  agroforestry becomes a key strategy in building a resilient,
          ...
          <motion.div className="order-1 lg:order-2">
            <div className="relative">
              ...
              >
                ...
                {/* Floating Tip */}
                <motion.div className="absolute -bottom-6 right-0 flex items-center gap-2 rounded-full bg-linear-to-r from-agri to-orange-600 px-4 py-2 text-xs font-medium text-white shadow-lg md:text-sm">
          ...
          <motion.div whileHover={{ y: -5 }} className="h-full">
            <div className="relative h-full rounded-3xl border border-nature/30 bg-card p-8 shadow-lg transition-all duration-300 hover:shadow-nature/10 md:p-10">
              ...
              <p className="text-base leading-relaxed text-justify text-muted-foreground md:text-lg">
                ...
                change, pollution & environmental degradation. By 2035, we aim
                to revolutionize natural resource management through
                community-led action, creating a greener, self-sustaining
                future.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className="h-full">
            <div className="relative h-full rounded-3xl border border-climate/30 bg-card p-8 shadow-lg transition-all duration-300 hover:shadow-climate/10 md:p-10">
              ...
              <p className="text-base text-justify leading-relaxed text-muted-foreground md:text-lg">
                To transform agriculture by promoting agroforestry and
                empowering communities to adopt sustainable practices that
                combat climate change, restore ecosystems, and ensure food
                security. We envision a greener planet by integrating innovative
                technologies with environmental stewardship.
              </p>
            </div>
          </motion.div>
        </div>
