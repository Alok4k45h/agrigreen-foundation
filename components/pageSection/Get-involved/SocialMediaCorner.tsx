...
// Dynamically import embeds so they only render on client
...
const socialConfigs = [
  {
    ...
    posts: [
      "https://www.linkedin.com/posts/chouhanshivrajsingh_integratedfarming-sustainableagriculture-ugcPost-7356626601423364096-8jyT",
      "https://www.linkedin.com/posts/indianchamber_lets-shape-the-future-of-ricesmarter-greener-activity-7353098224531816448-tOgT",
    ],
    Embed: LinkedInEmbed,
  },
  {
  ...
  },
  {
    ...
    posts: ["https://m.youtube.com/watch?v=_hEYuC51L6k"],
    Embed: YouTubeEmbed,
  },
];
